let products =[
    ...
    {
        name : "Orange",
        description: "An orange .Some say it's juicy",
        price : 9
    },
];
//Disply all products
...
function handleEvents(){
    ...
    document.querySelector('body').addEventListener('click',function(event){
        ...
        if(removeButton){
            ...
            //Remove product from array by name
